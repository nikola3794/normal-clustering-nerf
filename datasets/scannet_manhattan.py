...
from .scannet_manhattan_src.scene import ScanNetMannhatanScene


class ScanNetManhattanDataset(BaseDataset):
    def __init__(self, root_dir, hparams, split='train', **kwargs):
        ...
        assert not hparams.load_norm_gt
        assert not hparams.load_norm_depth_gt
